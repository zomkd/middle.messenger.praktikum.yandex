...
null == r &&
  ...
  r('27Lyk').register(
    JSON.parse(
      '{"1LzKV":"index.08b237b0.js","7cSvV":"lens-icon.53091bd3.svg","b3wcV":"index.ae2e211e.css"}',
    ),
  );
class a {
  constructor() {
...
class C {
  ...
  _onRoute(e) {
    ...
    if (!t) {
      const e = new k('/error-404', U, this.rootQuery);
...
class le extends f {
  ...
  onSubmit(e) {
    let t = {};
    (t = K(e, ['login', 'password'])), oe.signin(t);
  }
  render() {
...
((dt = ct || (ct = {})).Index = '/'),
  ...
  window.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
      await oe.fetchUser(), x.start(), e || x.go(ct.Chat);
    } catch (t) {
      x.start(), e && x.go(ct.Index);
    }
  });
//# sourceMappingURL=index.08b237b0.js.map
