...
null == r &&
  ...
  r('27Lyk').register(
    JSON.parse(
      '{"1LzKV":"index.445e1b1f.js","gSBIs":"send-icon.42b7d5de.svg","kM7MO":"attach-icon.25f0941c.svg","7cSvV":"lens-icon.53091bd3.svg","b3wcV":"index.5a00c179.css"}',
    ),
  );
class a {
  constructor() {
...
window.addEventListener('DOMContentLoaded', () => {
  const e = document.querySelector('#app'),
    ...
    c = new Fe({ href: '/views/auth/signIn/signIn.pug', value: 'signIn' }),
  ...
  switch (
    ...
    case '/views/auth/signIn/signIn.pug':
      e.replaceChildren(t.getContent()), t.dispatchComponentDidMount();
      break;
...
//# sourceMappingURL=index.445e1b1f.js.map
