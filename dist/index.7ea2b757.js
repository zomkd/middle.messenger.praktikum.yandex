...
null == r &&
  ...
  r('27Lyk').register(
    JSON.parse(
      '{"1LzKV":"index.7ea2b757.js","gSBIs":"send-icon.42b7d5de.svg","kM7MO":"attach-icon.25f0941c.svg","7cSvV":"lens-icon.53091bd3.svg","b3wcV":"index.5a00c179.css"}',
    ),
  );
class a {
  constructor() {
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  switch (
    ...
    case '/a':
      console.log('asdasd'),
        e.replaceChildren(n.getContent()),
        n.dispatchComponentDidMount();
      break;
...
//# sourceMappingURL=index.7ea2b757.js.map
