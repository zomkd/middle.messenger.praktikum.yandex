...
null == r &&
  ...
  r('27Lyk').register(
    JSON.parse(
      '{"1LzKV":"index.e8cc9478.js","7cSvV":"lens-icon.53091bd3.svg","b3wcV":"index.1ee46324.css"}',
    ),
  );
class a {
  constructor() {
...
class C {
  ...
  _onRoute(e) {
    ...
    if (!t) {
      const e = new k('/error-404', O, this.rootQuery);
      return console.log(e), void e.render();
    }
    this._currentRoute &&
...
class O extends f {
  ...
  render() {
    return this.compile(U, this.props);
  }
}
class A extends f {
  constructor(e) {
...
class ee {
  ...
  delete = (e, t) =>
    this.request(this.endpoint + e, { method: X.DELETE, data: t });
...
var ke = new (class extends te {
  ...
  deleteUsers(e, t) {
    return this.http.delete('/users', { users: t, chatId: e });
  }
  async getToken(e) {
...
var Pe = new (class {
  ...
  deleteUserToChat(e, t) {
    try {
      this.api.deleteUsers(e, [t]);
    } catch (e) {
      ae.set('user.error', e);
    }
  }
          ...
          events: {
            click: async () => {
              const e = this.children.addLink,
                t = e.getValue();
              Pe.addUserToChat(ae.getState().selectedChat, t), e.setValue('');
            },
          },
        }));
    }
...
var Ae = function (e) {
  ...
  return (
    function (e, s, i, r) {
      ...
      'deleteLink' in s
        ? s.deleteLink
        : 'undefined' != typeof deleteLink
        ? deleteLink
        : void 0,
      'deleteUserToChat' in s
        ? s.deleteUserToChat
        : 'undefined' != typeof deleteUserToChat
        ? deleteUserToChat
        : void 0,
      'img' in s ? s.img : 'undefined' != typeof img ? img : void 0,
      'username' in s
...
class Te extends f {
  ...
  init() {
    (this.children.deleteLink = new B({
      name: 'search',
      type: 'text',
      placeholder: 'Удалить пользователя по id',
    })),
      (this.children.deleteUserToChat = new j({
        type: 'submit',
        content: 'Удалить',
        events: {
          click: async () => {
            const e = this.children.deleteLink,
              t = e.getValue();
            Pe.deleteUserToChat(ae.getState().selectedChat, t), e.setValue('');
          },
        },
      }));
  }
...
const Ie = _e((e) => {
  ...
  class extends f {
    ...
    init() {
      oe.fetchUser(),
        (this.children.header = new Te({
          username: ae.getState().user.data.first_name,
          img: ae.getState().user.data.avatar
    ...
    createMessages(e) {
      return e.messages.map(
        (t) => new Re({ ...t, isMine: e.userId === t.user_id }),
      );
    }
    render() {
...
je = new URL(r('27Lyk').resolve('7cSvV'), import.meta.url).toString();
class Je extends f {
  constructor(e) {
    super(e);
  }
  init() {
    Pe.fetchChats(),
      oe.fetchUser(),
      (this.children.sidebar = new Ee({ title: 'Профиль', img: t(je) })),
      (this.children.mainChat = new Ie({})),
      Pe.fetchChats().finally(() => {
      ...
      (n =
        ...
        (n = i
          ? n +
            ...
            Ve('autofocus', !0, !0, !1) +
            '/><label' +
            Ve('class', Fe([`error error-${a}`], [!0]), !1, !1) +
            '>' +
            He(null == (t = s || '') ? '' : t) +
            '</label>'
          : n +
...
class et extends f {
  ...
  render() {
    return this.compile(Ye, this.props);
  }
}
var tt = function (e) {
  var t,
...
class nt extends f {
    ...
    (this.children.avatar = new et({
      ...
      events: {
        change: (e) => {
          ...
          t.append('avatar', n?.files[0]), Qe.avatar(t);
        },
      },
    })),
      (this.children.email = new ze({
        name: 'email',
        type: 'text',
        label: 'Почта',
        body: ae.getState().user.data.email,
      })),
      (this.children.login = new ze({
        name: 'login',
        type: 'text',
        label: 'Логин',
        body: ae.getState().user.data.login,
      })),
      (this.children.firstName = new ze({
        name: 'first_name',
        type: 'text',
        label: 'Имя',
        body: ae.getState().user.data.first_name,
      })),
      (this.children.secondName = new ze({
        name: 'second_name',
        type: 'text',
        label: 'Фамилия',
        body: ae.getState().user.data.second_name,
      })),
      (this.children.displayName = new ze({
        name: 'display_name',
        type: 'text',
        label: 'Имя в чате',
        body: ae.getState().user.data.display_name,
      })),
      (this.children.phone = new ze({
        name: 'phone',
        type: 'text',
        label: 'Телефон',
  ...
  render() {
    return this.compile(tt, this.props);
  }
}
const st = _e((e) => ({ ...e.user }))(nt);
var it = function (e) {
  var t,
    n = '',
    s = e || {};
...
class rt extends f {
  ...
  render() {
    return this.compile(it, this.props);
  }
}
var at = function (e) {
  var t,
...
class ot extends f {
  ...
  init() {
    (this.children.oldPassword = new ze({
      name: 'oldPassword',
      type: 'password',
      label: 'Старый пароль',
      ...
      (this.children.newPassword = new ze({
        name: 'newPassword',
        type: 'password',
      ...
      (this.children.repeatPassword = new ze({
        name: 'repeatPassword',
        type: 'password',
  ...
  render() {
    return this.compile(at, this.props);
  }
}
let ct;
var dt;
((dt = ct || (ct = {})).Index = '/'),
  ...
  (dt.ChangePassword = '/change-password'),
  (dt.Page404 = '/404'),
  (dt.Page500 = '/500'),
  window.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
      await oe.fetchUser(),
        x.start(),
        (e && !ae.getState().user.data) || x.go(ct.Chat);
    } catch (t) {
      x.start(), e && x.go(ct.Index);
    }
  });
//# sourceMappingURL=index.e8cc9478.js.map
